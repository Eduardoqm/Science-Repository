...
dir()
pm5=read.csv("Producao_agricola_Brasil2013.csv")
...
writeOGR(m01, dsn = '/mnt/data/dados_publicos/Documents/producao_agricola_municipal_2002_2014/shapes', layer ='Soja_2013', driver = 'ESRI Shapefile')
