###################################################
# Araguaia Valley-Croplands x EVI (2013)          #
#                                                 #
...
#Soybean
evi.soy.max=max(evi.soy.2013);names(evi.soy.max)="maximo"
evi.soy.mean=mean(evi.soy.2013);names(evi.soy.mean)="media"
evi.soy.median=calc(evi.soy.2013,fun=median);names(evi.soy.median)="median"

#Soy and Corn
evi.soyc.max=max(evi.soyc.2013);names(evi.soyc.max)="maximo"
evi.soyc.mean=mean(evi.soyc.2013);names(evi.soyc.mean)="media"
evi.soyc.median=calc(evi.soyc.2013,fun=median);names(evi.soyc.median)="median"

#Corn
evi.corn.max=max(evi.corn.2013);names(evi.corn.max)="maximo"
evi.corn.mean=mean(evi.corn.2013);names(evi.corn.mean)="media"
evi.corn.mediana=median(evi.corn.2013,na.rm=TRUE);names(evi.corn.mediana)="median"

#Soy and Cotton
evi.soycot.max=max(evi.soycot.2013);names(evi.soycot.max)="maximo"
evi.soycot.mean=mean(evi.soycot.2013);names(evi.soycot.mean)="media"
evi.soycot.median=calc(evi.soycot.2013,fun=median);names(evi.soycot.median)="median"
