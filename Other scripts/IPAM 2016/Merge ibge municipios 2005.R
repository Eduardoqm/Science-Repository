...
dir()
pm5=read.csv("Producao_agricola_Brasil2005.csv")
...
est$estado=as.character(est$estado2)
head(est)
##
##
...
writeOGR(m01, dsn = '/mnt/data/dados_publicos/Documents/producao_agricola_municipal_2002_2014/shapes', layer ='Soja_2005', driver = 'ESRI Shapefile')
