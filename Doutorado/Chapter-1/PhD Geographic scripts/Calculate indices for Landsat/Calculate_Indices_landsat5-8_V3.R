...
#Normalized Difference Infra-red (NDII)
ndii <- (b4-b5)/(b4+b5)

#Normalized Burned Ratio2 (NBR2)
nbr <- (b4-b7)/(b4+b7)
...
name2 = c("grnd")
grnd_names = paste(name2, name1, sep = "-", collapse = NULL)

name2 = c("ndii")
ndii_names = paste(name2, name1, sep = "-", collapse = NULL)

name2 = c("nbr")
nbr_names = paste(name2, name1, sep = "-", collapse = NULL)

name2 = c("nbr2")
nbr2_names = paste(name2, name1, sep = "-", collapse = NULL)
...
for (i in 1:length(grnd)) {
  writeRaster(grnd[[i]], grnd_names[[i]], format = "GTiff", bylayer = FALSE)
}
...
for (i in 1:length(nbr)) {
  writeRaster(nbr[[i]], nbr_names[[i]], format = "GTiff", bylayer = FALSE)
}

for (i in 1:length(nbr2)) {
  writeRaster(nbr2[[i]], nbr2_names[[i]], format = "GTiff", bylayer = FALSE)
}
...
for (i in 1:length(grnd_b)) {
  writeRaster(grnd_b[[i]], grnd_names[[i]], format = "GTiff", bylayer = FALSE)
}
...
for (i in 1:length(nbr_b)) {
  writeRaster(nbr_b[[i]], nbr_names[[i]], format = "GTiff", bylayer = FALSE)
}

for (i in 1:length(nbr2_b)) {
  writeRaster(nbr2_b[[i]], nbr2_names[[i]], format = "GTiff", bylayer = FALSE)
}
