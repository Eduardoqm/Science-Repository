...
litt = read.csv("1_master_liteira_area_1_jun2020.csv", sep = ",", header = TRUE)
...
#We know that the basket is 60x80 cm in area, so we calculate its area and convert it from cm2 to hectares. The weight of the litter is just to convert grams to tons.
...
#write.table(litt, "Liteira_full_tang.csv", sep = ",", row.names = F)
