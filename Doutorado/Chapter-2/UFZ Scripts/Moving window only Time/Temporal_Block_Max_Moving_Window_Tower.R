#---------------------------------------------------------------------------------------------------
# Temporal Block Maxima WS and Precipitation of Control Tower and Darro Station (Moving Window)
#
# Eduardo Q Marques 29-07-2022    Updated: 09-08-2022
#--------------------------------------------------------------------------------------------------
...
multd_plot = ggplot(multd, aes(x=Prec, y=Wind))+
  ...
  labs( x = "Maximum Precipitation (mm)", y = "Maximum Wind Speed (m/s)", title = "Tower (Max WS)/Darro Station - Temporal Block Maxima")+
...
test = ggplot(chis, aes(quant, value, fill = window, linetype = window))+
  ...
  labs(x = "Quantile theshold q", y = "Chi", title = "Tail Dependence (Maximum Tower)")+
