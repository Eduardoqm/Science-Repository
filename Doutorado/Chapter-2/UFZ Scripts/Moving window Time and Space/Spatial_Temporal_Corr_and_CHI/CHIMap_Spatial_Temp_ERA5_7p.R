...
write.csv(xingudf, "/home/queirozm/eqm_eth_ufz/Data/DataFrames/CHIs/CHI_Xingu_7p.csv", row.names = F)
...
map = ggplot()+
  ...
  labs(x=NULL, y=NULL, title = "Tail Dependence (1.75°)")+
  facet_wrap(~Days, nrow = 1)+
  theme_minimal()+
  theme(text = element_text(size = 14))

  ggsave(filename = "Xingu_CHIMap_7p.png", plot = map,
