...
ws = brick("ERA5_SL/ERA_SL_WG_block_3pixels.nc") #Wind Gust Bloked
...
ppt = brick("ERA5_land/ERA_Land_Prec_block_3pixels.nc") # Recurrent Precipitation from ERA5 Land
...
write.csv(xingudf, "/home/queirozm/eqm_eth_ufz/Data/DataFrames/CHIs/CHI_Xingu_3p.csv", row.names = F)
...
map = ggplot()+
  ...
  labs(x=NULL, y=NULL, title = "Tail Dependence (0.75°)")+
  facet_wrap(~Days, nrow = 1)+
  theme_minimal()+
  theme(text = element_text(size = 14))

  ggsave(filename = "Xingu_CHIMap_3p.png", plot = map,
