...
ws = brick("ERA5_SL/ERA_SL_WG_block_5pixels.nc") #Wind Gust Bloked
...
ppt = brick("ERA5_land/ERA_Land_Prec_block_5pixels.nc") # Recurrent Precipitation from ERA5 Land
...
write.csv(xingudf, "/home/queirozm/eqm_eth_ufz/Data/DataFrames/CHIs/CHI_Xingu_5p.csv", row.names = F)
...
map = ggplot()+
  ...
  labs(x=NULL, y=NULL, title = "Tail Dependence (1.25°)")+
  facet_wrap(~Days, nrow = 1)+
  theme_minimal()+
  theme(text = element_text(size = 14))

  ggsave(filename = "Xingu_CHIMap_5p.png", plot = map,
