#---------------------------------------------------------------------------------------------------
# Spatial and Temporal Block Maxima WG and Precipitation (Moving Window)
#
# Eduardo Q Marques 10-08-2022
#--------------------------------------------------------------------------------------------------

# Description: This script is the multi temporal block by 1, 3 and 5 days and spatial by 3, 5, or 7
# surronding pixels. Only for the pixel of Area-1
# Here we block by differente spatial/temporal windowns, plot correlation and calculate de CHI value of results.
...
p3 = read.csv("ERA5_Prec_WG_Area1_Point_3p.csv", sep = ",")
p5 = read.csv("ERA5_Prec_WG_Area1_Point_5p.csv", sep = ",")
p7 = read.csv("ERA5_Prec_WG_Area1_Point_7p.csv", sep = ",")

#BLOCKED BY 3 PIXELS (0.75 degrees) #####################################################################################
df = p3
#df = df %>% filter(Prec >= 0)
...
multd_plot = ggplot(multd, aes(x=Prec, y=Wind))+
  ...
  labs( x = "Maximum Precipitation (mm)", y = "Wind Gust (m/s)", title = "ERA5 - Spatial/Temporal Block Maxima (0.75)")+
...
ggsave(filename = "ERA_WG-Prec_spatial_3p_temp_1-3-5d.png", plot = multd_plot,
...
#write.csv(chis, file = "CHI_1-3-5days_3p.csv")

test = ggplot(chis, aes(quant, value, fill = window, linetype = window))+
  geom_line(aes(col = window))+
  labs(x = "Quantile theshold q", y = "Chi", title = "Tail Dependence (ERA5 - 0.75)")+
...
ggsave(filename = "ERA_CHI_WG-Prec_spatial_3p_temp_1-3-5d.png", plot = test,
path = "/home/queirozm/eqm_eth_ufz/Temp_figures/Spatial_Temporal_blocked",
width = 14, height = 10, units = "cm", dpi = 300)


#BLOCKED BY 5 PIXELS (1.25 degrees) #####################################################################################
df = p5
df$Prec = df$Prec*1000
df$year = substr(as.factor(df$Date), 1, 4)
...
multd_plot = ggplot(multd, aes(x=Prec, y=Wind))+
  ...
  geom_point(data=blw19, aes(x=Prec, y=Wind, fill=window), size=4, shape = 22)+
  stat_cor(aes(col = window), show.legend = F, label.y.npc="top", label.x.npc = 0.62)+
  labs( x = "Maximum Precipitation (mm)", y = "Wind Gust (m/s)", title = "ERA5 - Spatial/Temporal Block Maxima (1.25)")+
  scale_color_manual(values = c("orange", "blue", "red"))+
  scale_fill_manual(values = c("orange", "blue", "red"))+
  ylim(3, 16)+ xlim(0, 31)+
  theme_bw()+
...
ggsave(filename = "ERA_WG-Prec_spatial_5p_temp_1-3-5d.png", plot = multd_plot,
path = "/home/queirozm/eqm_eth_ufz/Temp_figures/Spatial_Temporal_blocked",
width = 12.5, height = 12.5, units = "cm", dpi = 300)
...
chis = rbind(chi_d1, chi_d3, chi_d5)
#write.csv(chis, file = "CHI_1-3-5days_5p.csv")

test = ggplot(chis, aes(quant, value, fill = window, linetype = window))+
  geom_line(aes(col = window))+
  labs(x = "Quantile theshold q", y = "Chi", title = "Tail Dependence (ERA5 - 1.25)")+
  geom_ribbon(aes(ymin = low, ymax = upp), alpha = 0.2)+
  scale_fill_manual(values = c("orange", "blue", "red"))+
  scale_color_manual(values = c("orange", "blue", "red"))+
  ylim(0, 1)+
...
ggsave(filename = "ERA_CHI_WG-Prec_spatial_5p_temp_1-3-5d.png", plot = test,
path = "/home/queirozm/eqm_eth_ufz/Temp_figures/Spatial_Temporal_blocked",
width = 14, height = 10, units = "cm", dpi = 300)


#BLOCKED BY 7 PIXELS (1.75 degrees) #####################################################################################
df = p7
df$Prec = df$Prec*1000
df$year = substr(as.factor(df$Date), 1, 4)
...
multd_plot = ggplot(multd, aes(x=Prec, y=Wind))+
  ...
  geom_point(data=blw19, aes(x=Prec, y=Wind, fill=window), size=4, shape = 22)+
  stat_cor(aes(col = window), show.legend = F, label.y.npc="top", label.x.npc = 0.62)+
  labs( x = "Maximum Precipitation (mm)", y = "Wind Gust (m/s)", title = "ERA5 - Spatial/Temporal Block Maxima (1.75)")+
  scale_color_manual(values = c("orange", "blue", "red"))+
  scale_fill_manual(values = c("orange", "blue", "red"))+
  ylim(3, 16)+ xlim(0, 31)+
  theme_bw()+
...
ggsave(filename = "ERA_WG-Prec_spatial_7p_temp_1-3-5d.png", plot = multd_plot,
path = "/home/queirozm/eqm_eth_ufz/Temp_figures/Spatial_Temporal_blocked",
width = 12.5, height = 12.5, units = "cm", dpi = 300)
...
chis = rbind(chi_d1, chi_d3, chi_d5)
#write.csv(chis, file = "CHI_1-3-5days_7p.csv")

test = ggplot(chis, aes(quant, value, fill = window, linetype = window))+
  geom_line(aes(col = window))+
  labs(x = "Quantile theshold q", y = "Chi", title = "Tail Dependence (ERA5 - 1.75)")+
  geom_ribbon(aes(ymin = low, ymax = upp), alpha = 0.2)+
  scale_fill_manual(values = c("orange", "blue", "red"))+
  scale_color_manual(values = c("orange", "blue", "red"))+
  ylim(0, 1)+
...
ggsave(filename = "ERA_CHI_WG-Prec_spatial_7p_temp_1-3-5d.png", plot = test,
path = "/home/queirozm/eqm_eth_ufz/Temp_figures/Spatial_Temporal_blocked",
width = 14, height = 10, units = "cm", dpi = 300)