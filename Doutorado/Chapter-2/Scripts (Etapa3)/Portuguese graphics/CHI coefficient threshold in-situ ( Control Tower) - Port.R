...
multd_plot = ggplot(multd, aes(x=Prec, y=Wind))+
  ...
  labs( x = "Precipitação Máxima (mm)", y = "Velocidade Máxima de Vento (m/s)", title = "b)",
  ...
  theme_bw()+
  theme(legend.position = c(0.9, 0.57)); multd_plot

ggsave(filename = "Tower_MaxWS-Prec_spatial_temporal_max_1-3-5days_port.png", plot = multd_plot,
...
ggsave(filename = "Tower_CHI_MaxWS-Prec_spatial_temporal_max_1-3-5days_port.png", plot = test,
       path = "C:/Users/Eduardo Q Marques/Documents/Research/Doutorado/Capitulo2/Figuras/Tese_Figures",
       width = 12, height = 10, units = "cm", dpi = 300)
