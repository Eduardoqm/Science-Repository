...
a = mapplot(d1, "a) No mesmo dia"); a
b = mapplot(d3, "b) Janela de três dias"); b
c = mapplot(d5, "c) Janela de cinco dias"); c

ggsave(filename = "1d_CHIMap_1979_2020_port.png", plot = a,
...
ggsave(filename = "3d_CHIMap_1979_2020_port.png", plot = b,
       path = "C:/Users/Eduardo Q Marques/Documents/Research/Doutorado/Capitulo2/Figuras/Tese_Figures",
       width = 30, height = 15, units = "cm", dpi = 300)

ggsave(filename = "5d_CHIMap_1979_2020_port.png", plot = c,
       path = "C:/Users/Eduardo Q Marques/Documents/Research/Doutorado/Capitulo2/Figuras/Tese_Figures",
       width = 30, height = 15, units = "cm", dpi = 300)
