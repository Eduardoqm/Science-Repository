...
setwd("C:/Users/Eduardo Q Marques/Documents/NDGI")
for (i in 1:length(ndgi)) {
  writeRaster(ndgi[[i]], names(b1[[i]]), format = "GTiff", bylayer = FALSE)
}
...
setwd("C:/Users/Eduardo Q Marques/Documents/NDGI")
for (i in 1:length(ndgi_b)) {
  writeRaster(ndgi_b[[i]], names(b2[[i]]), format = "GTiff", bylayer = FALSE)
}
setwd("C:/Users/Eduardo Q Marques/Documents/NDMI")
