...
#Todos os 100 valores das bandas por ano ==========================================================
#Azul
gg <- melt(azul, id.vars="data")
...
ggplot(gg, aes(Data,Refl, col=Parcela))+ 
  ...
  geom_vline(xintercept = 31, color = "red", linetype = "dashed")+
  annotate("text", x = 19, y = 50, label = "Experimento de fogo")+
  annotate("text", x = 30, y = 25, label = "TM")+
  annotate("text", x = 32, y = 25, label = "OLI")+
  theme(axis.text.x = element_text(angle = 90))

#Verde
gg <- melt(verde, id.vars="data")
colnames(gg) = c('Data', 'Parcela', 'Refl')
ggplot(gg, aes(Data,Refl, col=Parcela))+ 
  geom_boxplot()+
...
ggplot(gg, aes(Data,Refl, col=Parcela))+ 
  ...
  annotate("rect", xmin = 10, xmax = 29, ymin = 0, ymax = Inf, alpha = .2, fill = "red")+
  geom_vline(xintercept = 31, color = "red", linetype = "dashed")+
  annotate("text", x = 19, y = 500, label = "Experimento de fogo")+
  annotate("text", x = 30, y = 25, label = "TM")+
  annotate("text", x = 32, y = 25, label = "OLI")+
  theme(axis.text.x = element_text(angle = 90))

#Infravermelho medio
gg <- melt(irmedio, id.vars="data")
colnames(gg) = c('Data', 'Parcela', 'Refl')
ggplot(gg, aes(Data,Refl, col=Parcela))+ 
  geom_boxplot()+
  ...
  annotate("rect", xmin = 10, xmax = 29, ymin = 0, ymax = Inf, alpha = .2, fill = "red")+
  geom_vline(xintercept = 31, color = "red", linetype = "dashed")+
  annotate("text", x = 19, y = 200, label = "Experimento de fogo")+
  annotate("text", x = 30, y = 25, label = "TM")+
  annotate("text", x = 32, y = 25, label = "OLI")+
  theme(axis.text.x = element_text(angle = 90))

#Infravermelho medio 2
gg <- melt(irmedio2, id.vars="data")
colnames(gg) = c('Data', 'Parcela', 'Refl')
ggplot(gg, aes(Data,Refl, col=Parcela))+ 
  geom_boxplot()+
...
ggplot(gg, aes(Data,Refl, col=Parcela))+ 
  ...
  labs(title="Média BANDA (Azul)", fill= "Plot",x="Data",y="Reflectância")+
  annotate("rect", xmin = 10, xmax = 29, ymin = 0, ymax = Inf, alpha = .2, fill = "red")+
  geom_vline(xintercept = 31, color = "red", linetype = "dashed")+
  annotate("text", x = 19, y = 50, label = "Experimento de fogo")+
  annotate("text", x = 30, y = 25, label = "TM")+
...
ggplot(gg, aes(Data,Refl, col=Parcela))+ 
  geom_line(aes(group=Parcela))+
  labs(title="Média BANDA (Verde)", fill= "Plot",x="Data",y="Reflectância")+
  annotate("rect", xmin = 10, xmax = 29, ymin = 0, ymax = Inf, alpha = .2, fill = "red")+
  geom_vline(xintercept = 31, color = "red", linetype = "dashed")+
  annotate("text", x = 19, y = 50, label = "Experimento de fogo")+
  annotate("text", x = 30, y = 25, label = "TM")+
...
ggplot(gg, aes(Data,Refl, col=Parcela))+ 
  geom_line(aes(group=Parcela))+
  labs(title="Média BANDA (Vermelho)", fill= "Plot",x="Data",y="Reflectância")+
  annotate("rect", xmin = 10, xmax = 29, ymin = 0, ymax = Inf, alpha = .2, fill = "red")+
  geom_vline(xintercept = 31, color = "red", linetype = "dashed")+
  annotate("text", x = 19, y = 50, label = "Experimento de fogo")+
  annotate("text", x = 30, y = 25, label = "TM")+
...
ggplot(gg, aes(Data,Refl, col=Parcela))+ 
  geom_line(aes(group=Parcela))+
  labs(title="Média BANDA (IR Próximo)", fill= "Plot",x="Data",y="Reflectância")+
  annotate("rect", xmin = 10, xmax = 29, ymin = 0, ymax = Inf, alpha = .2, fill = "red")+
  geom_vline(xintercept = 31, color = "red", linetype = "dashed")+
  annotate("text", x = 19, y = 500, label = "Experimento de fogo")+
  annotate("text", x = 30, y = 25, label = "TM")+
...
ggplot(gg, aes(Data,Refl, col=Parcela))+ 
  geom_line(aes(group=Parcela))+
  labs(title="Média BANDA (IR Médio)", fill= "Plot",x="Data",y="Reflectância")+
  annotate("rect", xmin = 10, xmax = 29, ymin = 0, ymax = Inf, alpha = .2, fill = "red")+
  geom_vline(xintercept = 31, color = "red", linetype = "dashed")+
  annotate("text", x = 19, y = 200, label = "Experimento de fogo")+
  annotate("text", x = 30, y = 25, label = "TM")+
...
ggplot(gg, aes(Data,Refl, col=Parcela))+ 
  geom_line(aes(group=Parcela))+
  labs(title="Média BANDA (IR Médio 2)", fill= "Plot",x="Data",y="Reflectância")+
  annotate("rect", xmin = 10, xmax = 29, ymin = 0, ymax = Inf, alpha = .2, fill = "red")+
  geom_vline(xintercept = 31, color = "red", linetype = "dashed")+
  annotate("text", x = 19, y = 50, label = "Experimento de fogo")+
  annotate("text", x = 30, y = 25, label = "TM")+
...
#Mediana dos valores das bandas por ano ========================================================================
azul_md <- azul
azul_md$data = substr(azul_md$data, 1, 4)
...
verde_md <- verde
verde_md$data = substr(verde_md$data, 1, 4)
...
red_md <- red
red_md$data = substr(red_md$data, 1, 4)
...
irprox_md <- irprox
irprox_md$data = substr(irprox_md$data, 1, 4)
...
irmedio_md <- irmedio
irmedio_md$data = substr(irmedio_md$data, 1, 4)

irmedio_md = irmedio_md %>%
  group_by(data) %>% 
  summarise(controle = median(controle),
            b3yr = median(b3yr),
            b1yr = median(b1yr))

irmedio2_md <- irmedio2
...
#Graficos
#Azul
gg <- melt(azul_md, id.vars="data")
colnames(gg) = c('Data', 'Parcela', 'Refl')
ggplot(gg, aes(Data,Refl, col=Parcela))+ 
  geom_line(aes(group=Parcela))+
  labs(title="Mediana BANDA (Azul)", fill= "Plot",x="Data",y="Reflectância")+
...
gg <- melt(verde_md, id.vars="data")
colnames(gg) = c('Data', 'Parcela', 'Refl')
ggplot(gg, aes(Data,Refl, col=Parcela))+ 
  geom_line(aes(group=Parcela))+
  labs(title="Mediana BANDA (Verde)", fill= "Plot",x="Data",y="Reflectância")+
  annotate("rect", xmin = 5, xmax = 12, ymin = 0, ymax = Inf, alpha = .2, fill = "red")+
  geom_vline(xintercept = 13, color = "red", linetype = "dashed")+
  annotate("text", x = 8, y = 25, label = "Experimento de fogo")+
  annotate("text", x = 12.5, y = 25, label = "TM")+
...
gg <- melt(red_md, id.vars="data")
colnames(gg) = c('Data', 'Parcela', 'Refl')
ggplot(gg, aes(Data,Refl, col=Parcela))+ 
  geom_line(aes(group=Parcela))+
  labs(title="Mediana BANDA (Vermelho)", fill= "Plot",x="Data",y="Reflectância")+
  annotate("rect", xmin = 5, xmax = 12, ymin = 0, ymax = Inf, alpha = .2, fill = "red")+
  geom_vline(xintercept = 13, color = "red", linetype = "dashed")+
  annotate("text", x = 8, y = 25, label = "Experimento de fogo")+
  annotate("text", x = 12.5, y = 25, label = "TM")+
...
gg <- melt(irprox_md, id.vars="data")
colnames(gg) = c('Data', 'Parcela', 'Refl')
ggplot(gg, aes(Data,Refl, col=Parcela))+ 
  geom_line(aes(group=Parcela))+
  labs(title="Mediana BANDA (IR Próximo)", fill= "Plot",x="Data",y="Reflectância")+
  annotate("rect", xmin = 5, xmax = 12, ymin = 0, ymax = Inf, alpha = .2, fill = "red")+
  geom_vline(xintercept = 13, color = "red", linetype = "dashed")+
  annotate("text", x = 8, y = 25, label = "Experimento de fogo")+
  annotate("text", x = 12.5, y = 25, label = "TM")+
...
gg <- melt(irmedio_md, id.vars="data")
colnames(gg) = c('Data', 'Parcela', 'Refl')
ggplot(gg, aes(Data,Refl, col=Parcela))+ 
  geom_line(aes(group=Parcela))+
  labs(title="Mediana BANDA (IR Médio)", fill= "Plot",x="Data",y="Reflectância")+
  annotate("rect", xmin = 5, xmax = 12, ymin = 0, ymax = Inf, alpha = .2, fill = "red")+
  geom_vline(xintercept = 13, color = "red", linetype = "dashed")+
  annotate("text", x = 8, y = 25, label = "Experimento de fogo")+
  annotate("text", x = 12.5, y = 25, label = "TM")+
...
ggplot(gg, aes(Data,Refl, col=Parcela))+ 
  geom_line(aes(group=Parcela))+
  labs(title="Mediana BANDA (IR Médio 2)", fill= "Plot",x="Data",y="Reflectância")+
  annotate("rect", xmin = 5, xmax = 12, ymin = 0, ymax = Inf, alpha = .2, fill = "red")+
  geom_vline(xintercept = 13, color = "red", linetype = "dashed")+
  annotate("text", x = 8, y = 25, label = "Experimento de fogo")+
  annotate("text", x = 12.5, y = 25, label = "TM")+
