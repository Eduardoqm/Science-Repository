...
list <- list.files(path="C:/Users/Eduardo Q Marques/Documents/My Jobs/Doutorado/Deposito/Banco de Dados Tanguro/Tanguro Indices/Hyperion/2005", pattern = ".tif$", full.names=TRUE,recursive=TRUE)
...
#EVI =====================
a = bloco_a %>% 
  filter(index == 'evi.2005')
a$index[a$index == 'evi.2005'] <- 'control'
colnames(a) = c('gradient', 'plots', 'evi')

b = bloco_b %>% 
  filter(index == 'evi.2005')
b$index[b$index == 'evi.2005'] <- 'b1yr'
colnames(b) = c('gradient', 'plots', 'evi')

c = bloco_c %>% 
  filter(index == 'evi.2005')
c$index[c$index == 'evi.2005'] <- 'b3yr'
...
#EVI2 ======================
a = bloco_a %>% 
  filter(index == 'evi2.2005')
a$index[a$index == 'evi2.2005'] <- 'control'
colnames(a) = c('gradient', 'plots', 'evi2')

b = bloco_b %>% 
  filter(index == 'evi2.2005')
b$index[b$index == 'evi2.2005'] <- 'b1yr'
colnames(b) = c('gradient', 'plots', 'evi2')

c = bloco_c %>% 
  filter(index == 'evi2.2005')
c$index[c$index == 'evi2.2005'] <- 'b3yr'
...
#NDVI===================
a = bloco_a %>% 
  filter(index == 'ndvi.2005')
a$index[a$index == 'ndvi.2005'] <- 'control'
colnames(a) = c('gradient', 'plots', 'ndvi')

b = bloco_b %>% 
  filter(index == 'ndvi.2005')
b$index[b$index == 'ndvi.2005'] <- 'b1yr'
colnames(b) = c('gradient', 'plots', 'ndvi')

c = bloco_c %>% 
  filter(index == 'ndvi.2005')
c$index[c$index == 'ndvi.2005'] <- 'b3yr'
...
#MSI===================
a = bloco_a %>% 
  filter(index == 'msi.2005')
a$index[a$index == 'msi.2005'] <- 'control'
colnames(a) = c('gradient', 'plots', 'msi')

b = bloco_b %>% 
  filter(index == 'msi.2005')
b$index[b$index == 'msi.2005'] <- 'b1yr'
colnames(b) = c('gradient', 'plots', 'msi')

c = bloco_c %>% 
  filter(index == 'msi.2005')
c$index[c$index == 'msi.2005'] <- 'b3yr'
...
#WBI ===============
a = bloco_a %>% 
  filter(index == 'wbi.2005')
a$index[a$index == 'wbi.2005'] <- 'control'
colnames(a) = c('gradient', 'plots', 'wbi')

b = bloco_b %>% 
  filter(index == 'wbi.2005')
b$index[b$index == 'wbi.2005'] <- 'b1yr'
colnames(b) = c('gradient', 'plots', 'wbi')

c = bloco_c %>% 
  filter(index == 'wbi.2005')
c$index[c$index == 'wbi.2005'] <- 'b3yr'
...
#VIG ================
a = bloco_a %>% 
  filter(index == 'vig.2005')
a$index[a$index == 'vig.2005'] <- 'control'
colnames(a) = c('gradient', 'plots', 'vig')

b = bloco_b %>% 
  filter(index == 'vig.2005')
b$index[b$index == 'vig.2005'] <- 'b1yr'
colnames(b) = c('gradient', 'plots', 'vig')

c = bloco_c %>% 
  filter(index == 'vig.2005')
c$index[c$index == 'vig.2005'] <- 'b3yr'
...
#VARI ===============
a = bloco_a %>% 
  filter(index == 'vari.2005')
a$index[a$index == 'vari.2005'] <- 'control'
colnames(a) = c('gradient', 'plots', 'vari')

b = bloco_b %>% 
  filter(index == 'vari.2005')
b$index[b$index == 'vari.2005'] <- 'b1yr'
colnames(b) = c('gradient', 'plots', 'vari')

c = bloco_c %>% 
  filter(index == 'vari.2005')
c$index[c$index == 'vari.2005'] <- 'b3yr'
...
#SIPI ===============
a = bloco_a %>% 
  filter(index == 'sipi.2005')
a$index[a$index == 'sipi.2005'] <- 'control'
colnames(a) = c('gradient', 'plots', 'sipi')

b = bloco_b %>% 
  filter(index == 'sipi.2005')
b$index[b$index == 'sipi.2005'] <- 'b1yr'
colnames(b) = c('gradient', 'plots', 'sipi')

c = bloco_c %>% 
  filter(index == 'sipi.2005')
c$index[c$index == 'sipi.2005'] <- 'b3yr'
...
#RENDVI =============
a = bloco_a %>% 
  filter(index == 'rendvi.2005')
a$index[a$index == 'rendvi.2005'] <- 'control'
colnames(a) = c('gradient', 'plots', 'rendvi')

b = bloco_b %>% 
  filter(index == 'rendvi.2005')
b$index[b$index == 'rendvi.2005'] <- 'b1yr'
colnames(b) = c('gradient', 'plots', 'rendvi')

c = bloco_c %>% 
  filter(index == 'rendvi.2005')
c$index[c$index == 'rendvi.2005'] <- 'b3yr'
...
#PSSR ================
a = bloco_a %>% 
  filter(index == 'pssr.2005')
a$index[a$index == 'pssr.2005'] <- 'control'
colnames(a) = c('gradient', 'plots', 'pssr')

b = bloco_b %>% 
  filter(index == 'pssr.2005')
b$index[b$index == 'pssr.2005'] <- 'b1yr'
colnames(b) = c('gradient', 'plots', 'pssr')

c = bloco_c %>% 
  filter(index == 'pssr.2005')
c$index[c$index == 'pssr.2005'] <- 'b3yr'
...
#PSRI ===================
a = bloco_a %>% 
  filter(index == 'psri.2005')
a$index[a$index == 'psri.2005'] <- 'control'
colnames(a) = c('gradient', 'plots', 'psri')

b = bloco_b %>% 
  filter(index == 'psri.2005')
b$index[b$index == 'psri.2005'] <- 'b1yr'
colnames(b) = c('gradient', 'plots', 'psri')

c = bloco_c %>% 
  filter(index == 'psri.2005')
c$index[c$index == 'psri.2005'] <- 'b3yr'
...
#PRI ====================
a = bloco_a %>% 
  filter(index == 'pri.2005')
a$index[a$index == 'pri.2005'] <- 'control'
colnames(a) = c('gradient', 'plots', 'pri')

b = bloco_b %>% 
  filter(index == 'pri.2005')
b$index[b$index == 'pri.2005'] <- 'b1yr'
colnames(b) = c('gradient', 'plots', 'pri')

c = bloco_c %>% 
  filter(index == 'pri.2005')
c$index[c$index == 'pri.2005'] <- 'b3yr'
...
#NIRV ===================
a = bloco_a %>% 
  filter(index == 'nirv.2005')
a$index[a$index == 'nirv.2005'] <- 'control'
colnames(a) = c('gradient', 'plots', 'nirv')

b = bloco_b %>% 
  filter(index == 'nirv.2005')
b$index[b$index == 'nirv.2005'] <- 'b1yr'
colnames(b) = c('gradient', 'plots', 'nirv')

c = bloco_c %>% 
  filter(index == 'nirv.2005')
c$index[c$index == 'nirv.2005'] <- 'b3yr'
...
#NDWI ====================
a = bloco_a %>% 
  filter(index == 'ndwi.2005')
a$index[a$index == 'ndwi.2005'] <- 'control'
colnames(a) = c('gradient', 'plots', 'ndwi')

b = bloco_b %>% 
  filter(index == 'ndwi.2005')
b$index[b$index == 'ndwi.2005'] <- 'b1yr'
colnames(b) = c('gradient', 'plots', 'ndwi')

c = bloco_c %>% 
  filter(index == 'ndwi.2005')
c$index[c$index == 'ndwi.2005'] <- 'b3yr'
...
#NDII =====================
a = bloco_a %>% 
  filter(index == 'ndii.2005')
a$index[a$index == 'ndii.2005'] <- 'control'
colnames(a) = c('gradient', 'plots', 'ndii')

b = bloco_b %>% 
  filter(index == 'ndii.2005')
b$index[b$index == 'ndii.2005'] <- 'b1yr'
colnames(b) = c('gradient', 'plots', 'ndii')

c = bloco_c %>% 
  filter(index == 'ndii.2005')
c$index[c$index == 'ndii.2005'] <- 'b3yr'
...
#LWVI2 =====================
a = bloco_a %>% 
  filter(index == 'lwvi2.2005')
a$index[a$index == 'lwvi2.2005'] <- 'control'
colnames(a) = c('gradient', 'plots', 'lwvi2')

b = bloco_b %>% 
  filter(index == 'lwvi2.2005')
b$index[b$index == 'lwvi2.2005'] <- 'b1yr'
colnames(b) = c('gradient', 'plots', 'lwvi2')

c = bloco_c %>% 
  filter(index == 'lwvi2.2005')
c$index[c$index == 'lwvi2.2005'] <- 'b3yr'
...
#ARI ======================
a = bloco_a %>% 
  filter(index == 'ari.2005')
a$index[a$index == 'ari.2005'] <- 'control'
colnames(a) = c('gradient', 'plots', 'ari')

b = bloco_b %>% 
  filter(index == 'ari.2005')
b$index[b$index == 'ari.2005'] <- 'b1yr'
colnames(b) = c('gradient', 'plots', 'ari')

c = bloco_c %>% 
  filter(index == 'ari.2005')
c$index[c$index == 'ari.2005'] <- 'b3yr'
