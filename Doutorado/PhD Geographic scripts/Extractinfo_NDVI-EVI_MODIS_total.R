...
ggplot(gg, aes(Data,Refl, col=Parcela))+ 
  ...
  annotate("segment", x = c(8.5, 11.5, 15.5), y = 1.4, 
           xend = c(8.5, 11.5, 15.5), yend = c(1.2, 1.2, 1.2),
           arrow = arrow(angle = 20, length = unit(2, "mm"), type = "closed"))+
  
  annotate("text", x = 2.5, y = -0.1, label = "Pré-fogo", colour = "darkgreen")+
  annotate("rect", xmin = 1, xmax = 5, ymin = -0.29, ymax = -0.19, alpha = 0.9, fill = "darkgreen")+
  
  annotate("text", x = 8.5, y = -0.1, label = "Experimento de fogo", colour = "red")+
  annotate("rect", xmin = 5, xmax = 12, ymin = -0.29, ymax = -0.19, alpha = 0.9, fill = "red")+
  annotate("text", x = c(5.5, 8.5, 11.5), y = -0.22, label = "xx", colour = "yellow")+
  annotate("text", x = c(6.5, 7.5, 10.5), y = -0.22, label = "x", colour = "yellow")+
  
  annotate("text", x = 15.5, y = -0.1, label = "Periodo de recuperação", colour = "darkblue")+
  annotate("rect", xmin = 12, xmax = 20, ymin = -0.29, ymax = -0.19, alpha = 0.9, fill = "darkblue")+
  theme_minimal()+
