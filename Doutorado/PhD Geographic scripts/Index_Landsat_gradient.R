...
#NDVI===================
a = bloco_a %>% 
  filter(index == 'LT05_L1TP_224069_20050610_20161126_01_T1_sr_band1')
a$index[a$index == 'LT05_L1TP_224069_20050610_20161126_01_T1_sr_band1'] <- 'Control'
colnames(a) = c('gradient', 'plots', 'ndvi')

b = bloco_b %>% 
  filter(index == 'LT05_L1TP_224069_20050610_20161126_01_T1_sr_band1')
b$index[b$index == 'LT05_L1TP_224069_20050610_20161126_01_T1_sr_band1'] <- 'B1yr'
colnames(b) = c('gradient', 'plots', 'ndvi')

c = bloco_c %>% 
  filter(index == 'LT05_L1TP_224069_20050610_20161126_01_T1_sr_band1')
c$index[c$index == 'LT05_L1TP_224069_20050610_20161126_01_T1_sr_band1'] <- 'B3yr'
