---
title: "Difference by Edge and Core"
output:
...
```
Here are the graphs of the relative difference between the control and the burned plots, separated for the edge and core of the forest. 
...
df2 = df[,c(1,2,3,19,20,21,22)]
knitr::kable(head(df2, 100))
```

### Summary Data
```{r, echo=FALSE, results = 'asis'}
df3 = df[,c(19,20,21,22)]
knitr::kable(summary(df3, 100))
```

## Graphics by category {.tabset}
