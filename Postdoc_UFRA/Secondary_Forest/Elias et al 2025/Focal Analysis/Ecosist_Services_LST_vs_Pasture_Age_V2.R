#LST Pasture by Forest Age (Focal)
...
#Focal
save_delta_raster(lst_year, "Delta_LST_Pasture_age_Annual_2022.tif")
save_delta_raster(lst_dry,  "Delta_LST_Pasture_age_Dry_2022.tif")
save_delta_raster(lst_wet,  "Delta_LST_Pasture_age_Rainy_2022.tif")

Delta_year  <- rast("Delta_LST_Pasture_age_Annual_2022.tif")  
Delta_dry  <- rast("Delta_LST_Pasture_age_Dry_2022.tif")  
Delta_wet  <- rast("Delta_LST_Pasture_age_Rainy_2022.tif")  
...
write.csv(final_df2, "LST_Pasture_age_2022.csv", row.names = FALSE)
