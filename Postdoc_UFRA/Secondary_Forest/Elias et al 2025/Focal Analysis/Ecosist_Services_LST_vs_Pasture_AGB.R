...
write.csv(resf2, "LST_AGB_Past_Annual_full.csv", row.names = F)
rm(resf2)
...
write.csv(resf2, "LST_AGB_Past_Dry_full.csv", row.names = F)
rm(resf2)
...
write.csv(resf2, "LST_AGB_Past_Rainy_full.csv", row.names = F)
