#Percentages of Secondary Forest (LST - AGB test)
...
ggsave(plot = gg5, "Delta_LST_AGB_5_perc.png", dpi = 300,
...
ggsave(plot = gg30, "Delta_LST_AGB_30_perc.png", dpi = 300,
       height = 10, width = 15, units = "cm")
...
ggsave(plot = gg50, "Delta_LST_AGB_50_perc.png", dpi = 300,
       height = 10, width = 15, units = "cm")
...
ggsave(plot = gg100, "Delta_LST_AGB_100_perc.png", dpi = 300,
       height = 10, width = 15, units = "cm")
