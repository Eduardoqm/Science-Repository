...
gg5 = ggplot(df5, aes(x=agb, y=et, col = cond))+
  geom_point(size = 3)+
  stat_smooth()+
  labs(x="Aboveground Biomass (Mg/ha)",y="Δ Evapotranspiration (mm/year)",
       col = "Condition", title = "Secondary vs. Primary Forest - Purity >5%")+
  scale_color_manual(values = c("#66bd63", "#fc8d59", "#67a9cf"))+
  theme_minimal(); gg5

ggsave(plot = gg5, "Delta_ET_AGB_5_perc.png", dpi = 300,
...
ggsave(plot = gg30, "Delta_ET_AGB_30_perc.png", dpi = 300,
       height = 10, width = 15, units = "cm")
...
ggsave(plot = gg50, "Delta_ET_AGB_50_perc.png", dpi = 300,
       height = 10, width = 15, units = "cm")
...
ggsave(plot = gg70, "Delta_ET_AGB_70_perc.png", dpi = 300,
       height = 10, width = 15, units = "cm")
...
ggsave(plot = gg100, "Delta_ET_AGB_100_perc.png", dpi = 300,
       height = 10, width = 15, units = "cm")
