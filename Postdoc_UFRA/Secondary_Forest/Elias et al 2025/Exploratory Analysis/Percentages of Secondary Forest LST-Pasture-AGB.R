...
gg5 = ggplot(df5, aes(x=agb, y=lst, col = cond))+
  geom_point(size = 3)+
  stat_smooth()+
...
ggsave(plot = gg5, "Delta_LST_Past_AGB_5_perc.png", dpi = 300,
       height = 10, width = 15, units = "cm")


gg30 = ggplot(df30, aes(x=agb, y=lst, col = cond))+
  geom_point(size = 3)+
  stat_smooth()+
  labs(x="Aboveground Biomass (Mg/ha)",y="Δ LST (C°)",
...
ggsave(plot = gg30, "Delta_LST_Past_AGB_30_perc.png", dpi = 300,
       height = 10, width = 15, units = "cm")


gg50 = ggplot(df50, aes(x=agb, y=lst, col = cond))+
  geom_point(size = 3)+
  stat_smooth()+
  labs(x="Aboveground Biomass (Mg/ha)",y="Δ LST (C°)",
...
ggsave(plot = gg50, "Delta_LST_Past_AGB_50_perc.png", dpi = 300,
       height = 10, width = 15, units = "cm")

gg70 = ggplot(df70, aes(x=agb, y=lst, col = cond))+
  geom_point(size = 3)+
  stat_smooth()+
  labs(x="Aboveground Biomass (Mg/ha)",y="Δ LST (C°)",
...
ggsave(plot = gg70, "Delta_LST_Past_AGB_70_perc.png", dpi = 300,
       height = 10, width = 15, units = "cm")


gg100 = ggplot(df100, aes(x=agb, y=lst, col = cond))+
  geom_point(size = 3)+
  stat_smooth()+
  labs(x="Aboveground Biomass (Mg/ha)",y="Δ LST (C°)",
...
ggsave(plot = gg100, "Delta_LST_Past_AGB_100_perc.png", dpi = 300,
       height = 10, width = 15, units = "cm")
