#Percentages of Secondary Forest (ET - Pasture test)
...
gg5 = ggplot(df5, aes(x=sf_age, y=et, col = cond))+
  geom_point(size = 3)+
  stat_smooth()+
  labs(x="Secondary forest age (year)",y="Δ Evapotranspiration (mm/year)",
       col = "Condition", title = "Secondary Forest vs. Pasture - Purity >5%")+
  scale_color_manual(values = c("#66bd63", "#fc8d59", "#67a9cf"))+
  theme_minimal(); gg5

ggsave(plot = gg5, "Delta_ET_Pasture_5_perc.png", dpi = 300,
       height = 10, width = 15, units = "cm")


gg30 = ggplot(df30, aes(x=sf_age, y=et, col = cond))+
  geom_point(size = 3)+
  stat_smooth()+
  labs(x="Secondary forest age (year)",y="Δ Evapotranspiration (mm/year)",
...
ggsave(plot = gg30, "Delta_ET_Pasture_30_perc.png", dpi = 300,
       height = 10, width = 15, units = "cm")


gg50 = ggplot(df50, aes(x=sf_age, y=et, col = cond))+
  geom_point(size = 3)+
  stat_smooth()+
  labs(x="Secondary forest age (year)",y="Δ Evapotranspiration (mm/year)",
...
ggsave(plot = gg50, "Delta_ET_Pasture_50_perc.png", dpi = 300,
       height = 10, width = 15, units = "cm")

gg70 = ggplot(df70, aes(x=sf_age, y=et, col = cond))+
  geom_point(size = 3)+
  stat_smooth()+
  labs(x="Secondary forest age (year)",y="Δ Evapotranspiration (mm/year)",
...
ggsave(plot = gg70, "Delta_ET_Pasture_70_perc.png", dpi = 300,
       height = 10, width = 15, units = "cm")


gg100 = ggplot(df100, aes(x=sf_age, y=et, col = cond))+
  geom_point(size = 3)+
  stat_smooth()+
  labs(x="Secondary forest age (year)",y="Δ Evapotranspiration (mm/year)",
...
ggsave(plot = gg100, "Delta_ET_Pasture_100_perc.png", dpi = 300,
       height = 10, width = 15, units = "cm")
