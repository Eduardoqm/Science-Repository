#Percentages of Secondary Forest (et - Forest Age test)
...
ggsave(plot = gg5, "Delta_ET_SecFor_5_perc.png", dpi = 300,
...
ggsave(plot = gg30, "Delta_ET_SecFor_30_perc.png", dpi = 300,
       height = 10, width = 15, units = "cm")
...
ggsave(plot = gg50, "Delta_ET_SecFor_50_perc.png", dpi = 300,
       height = 10, width = 15, units = "cm")
...
ggsave(plot = gg70, "Delta_ET_SecFor_70_perc.png", dpi = 300,
       height = 10, width = 15, units = "cm")
...
ggsave(plot = gg100, "Delta_ET_SecFor_100_perc.png", dpi = 300,
       height = 10, width = 15, units = "cm")
