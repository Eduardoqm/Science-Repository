...
setwd("G:/My Drive/Research/Papers/Serrapilheira (Elias et al)/Scenery") #Leptop
dir()
...
df_delta = read.csv("G:/My Drive/Research/Papers/Serrapilheira (Elias et al)/Scenery/ET_Pasture_age_FULL.csv")
...
#Result
3.20 - 3.21 #-0.01
#Converting SF in Pasture decrease evapotranspiration in 0.01 mm/day.
...
#Result
3.17 - 3.21 #-0.04
#Converting Pasture to young SF, the evapotranspiration decrease 0.04 mm/day.
...
#Result
3.27 - 3.21 #0.06
#Converting Pasture to SF, in mean the evapotranspiration increase 0.06 mm/day.
...
#Result
3.32 - 3.21 #0.11
#Converting Pasture to 38 year old SF, the evapotranspiration increase 0.11 mm/day.
