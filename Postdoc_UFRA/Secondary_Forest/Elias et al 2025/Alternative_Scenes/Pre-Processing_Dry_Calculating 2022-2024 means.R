#Calculating 2022-2024 means (Dry)
...
#LST
lst22 <- rast("LST_Landsat_Dry_2022_70m.tif")
lst23 <- rast("LST_Landsat_Dry_2023_70m.tif")
lst24 <- rast("LST_Landsat_Dry_2024_70m.tif")

lst_cur = mean(lst22, lst23, lst24, na.rm = T)
plot(lst_cur)

#ET
et22 <- rast("ECOSTRESS_ET_Dry_2022_70m.tif")
et23 <- rast("ECOSTRESS_ET_Dry_2023_70m.tif")
et24 <- rast("ECOSTRESS_ET_Dry_2024_70m.tif")

et_cur = mean(et22, et23, et24, na.rm = T)
plot(et_cur)

setwd("G:/Meu Drive/Dados_Elias_paper/LST_ET_scenario")
writeRaster(lst_cur, "LST_Dry_current.tif")
writeRaster(et_cur, "ET_Dry_current.tif")
...
setwd("G:/Meu Drive/Dados_Elias_paper/LST_ET_scenario")
writeRaster(delta_et_f, "Forest_Delta_ET_Dry.tif")
writeRaster(delta_et_p, "Pasture_Delta_ET_Dry.tif")
writeRaster(delta_lst_f, "Forest_Delta_LST_Dry.tif")
writeRaster(delta_lst_p, "Pasture_Delta_LST_Dry.tif")
