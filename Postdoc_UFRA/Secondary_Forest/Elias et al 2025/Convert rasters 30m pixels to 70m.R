...
base = rast("Base.tif")
evp_year = rast("ECOSTRESS_ET_Annual_2022.tif")
evp_dry = rast("ECOSTRESS_ET_Dry_2022.tif")
evp_wet = rast("ECOSTRESS_ET_Rainy_2022.tif")
